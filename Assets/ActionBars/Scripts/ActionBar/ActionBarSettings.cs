...
{
	public System.Collections.Generic.List<UIAtlas> Atlas;	
	...
	static ActionBarSettings mInstance = null;
	[HideInInspector]
	public System.Collections.Generic.List<ActionBarButton> Buttons;
    ...
    public static ActionBarSettings Instance
    {
        ...
        get
        {
            if (mInstance == null)
            {
                mInstance = FindObjectOfType(typeof(ActionBarSettings)) as ActionBarSettings;
            }
